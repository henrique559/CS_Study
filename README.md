# Roadmap de Estudos (Ciência da Computação)
...
- [Aprenda fazendo](https://www.engines4ed.org/hyperbook/nodes/NODE-120-pg.html)
- Respositorio interessa sobre [engenharia de software](https://github.com/AlexGalhardo/Software-Engineering)
### Lembretes
...
### Conceitos:
- [ ] [Structure and Interpretation of Computer Programs - Brian Harvey’s](https://archive.org/details/ucberkeley-webcast-PL3E89002AA9B9879E?sort=titleSorter) (Ajuda para realizar [Aqui](https://github.com/abrantesasf/sicp-abrantes-study-guide)) ou [How to Design Programs](https://htdp.org/2023-8-14/Book/index.html)
...
### Inicio:
- [ ] C#: A Player's Guide & Object Oriented Programming
- [ ] Entendendo Algoritmos
- [ ] SQLite: Introdução
- [ ] dotnet CLI
...
- [Cross-platform Brainfuck Interpreter implementation in Rust](https://rtoch.com/posts/brainfuck-interpreter-implementation-part-1/)
